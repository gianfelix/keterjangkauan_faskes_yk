...
var features_AreaKeterjangkauanFaskes_3 = format_AreaKeterjangkauanFaskes_3.readFeatures(json_AreaKeterjangkauanFaskes_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_AreaKeterjangkauanFaskes_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_AreaKeterjangkauanFaskes_3.addFeatures(features_AreaKeterjangkauanFaskes_3);
var lyr_AreaKeterjangkauanFaskes_3 = new ol.layer.Vector({
                ...
                interactive: true,
    title: 'Area Keterjangkauan Faskes<br />\
...
var lyr_Jalan_5 = new ol.layer.Vector({
                ...
                interactive: true,
    title: 'Jalan<br />\
    <img src="styles/legend/Jalan_5_0.png" /> arteri<br />\
    <img src="styles/legend/Jalan_5_1.png" /> kolektor<br />\
    <img src="styles/legend/Jalan_5_2.png" /> lokal<br />\
    <img src="styles/legend/Jalan_5_3.png" /> <br />'
        });
...
lyr_GoogleRoad_0.setVisible(true);lyr_GoogleSatellite_1.setVisible(true);lyr_OSMStandard_2.setVisible(true);lyr_AreaKeterjangkauanFaskes_3.setVisible(true);lyr_BatasAdministrasiKecamatan_4.setVisible(true);lyr_Jalan_5.setVisible(true);lyr_FasilitasKesehatan_6.setVisible(true);
var layersList = [lyr_GoogleRoad_0,lyr_GoogleSatellite_1,lyr_OSMStandard_2,lyr_AreaKeterjangkauanFaskes_3,lyr_BatasAdministrasiKecamatan_4,lyr_Jalan_5,lyr_FasilitasKesehatan_6];
lyr_AreaKeterjangkauanFaskes_3.set('fieldAliases', {'FID_SA_tim': 'FID_SA_tim', 'keterangan': 'keterangan', });
lyr_BatasAdministrasiKecamatan_4.set('fieldAliases', {'kecamatan': 'kecamatan', });
lyr_Jalan_5.set('fieldAliases', {'name': 'name', 'Kls_jalan': 'Kls_jalan', 'Panjang_JL': 'Panjang_JL', });
lyr_FasilitasKesehatan_6.set('fieldAliases', {'Nama_RS': 'Nama_RS', 'Kategori': 'Kategori', 'Kecamatan': 'Kecamatan', 'Easting': 'Easting', 'Northing': 'Northing', 'Field6': 'Field6', });
lyr_AreaKeterjangkauanFaskes_3.set('fieldImages', {'FID_SA_tim': 'TextEdit', 'keterangan': 'TextEdit', });
lyr_BatasAdministrasiKecamatan_4.set('fieldImages', {'kecamatan': 'TextEdit', });
lyr_Jalan_5.set('fieldImages', {'name': 'TextEdit', 'Kls_jalan': 'TextEdit', 'Panjang_JL': 'TextEdit', });
lyr_FasilitasKesehatan_6.set('fieldImages', {'Nama_RS': 'TextEdit', 'Kategori': 'TextEdit', 'Kecamatan': 'TextEdit', 'Easting': 'TextEdit', 'Northing': 'TextEdit', 'Field6': 'TextEdit', });
lyr_AreaKeterjangkauanFaskes_3.set('fieldLabels', {'FID_SA_tim': 'no label', 'keterangan': 'no label', });
lyr_BatasAdministrasiKecamatan_4.set('fieldLabels', {'kecamatan': 'no label', });
lyr_Jalan_5.set('fieldLabels', {'name': 'no label', 'Kls_jalan': 'no label', 'Panjang_JL': 'no label', });
lyr_FasilitasKesehatan_6.set('fieldLabels', {'Nama_RS': 'no label', 'Kategori': 'no label', 'Kecamatan': 'no label', 'Easting': 'no label', 'Northing': 'no label', 'Field6': 'no label', });
